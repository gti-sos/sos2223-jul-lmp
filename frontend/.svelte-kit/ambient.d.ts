...
declare module '$env/static/private' {
	...
	export const CCP_HOME: string;
	export const CCP_JOBTEMPLATE: string;
	export const CCP_LOGROOT_USR: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		APPDATA: string;
		CCP_HOME: string;
		CCP_JOBTEMPLATE: string;
		CCP_LOGROOT_USR: string;
